  ...
  return (
    <div>
      <section className="grid grid-cols-3 mb-12">
        <div className="pl-10">
          <h1 className="uppercase font-bold bg-red-600">Tümer Görkem</h1>
        </div>
        <div>
          <h1>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sed et
            praesentium delectus commodi ipsa inventore. Cupiditate unde nisi
            quo asperiores eveniet nesciunt molestias explicabo, recusandae vel
            doloremque nam amet similique!
          </h1>
        </div>
        <div>
          <nav>
      ...
      <section className="grid grid-column-2">
        <div className="flex justify-center ">
          <img alt="perso" width="36%" height="auto" />
        </div>
